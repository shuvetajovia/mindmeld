  ...
  return (
    <div className="p-6 max-w-[1600px] mx-auto text-textPrimary space-y-8 animate-fadeIn">
      ...
      <div className="bg-bgCard rounded-3xl p-8 border border-borderColor shadow-sm relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-start gap-4">
          ...
          <p className="text-sm md:text-base font-semibold text-textSecondary max-w-3xl leading-relaxed">
            An end-to-end intelligent disaster management grid designed to proactively mitigate landslide hazards in vulnerable mountainous regions through multi-tier AI fusion, satellite geomorphology (DEM), and real-time geotechnical IoT telemetry across Northeast India.
          </p>
          
          <div className="flex flex-wrap gap-3 mt-2">
            <button 
              onClick={onLaunchGIS}
              className="px-6 py-3.5 bg-blue-600 hover:bg-blue-700 text-white rounded-xl text-sm font-black uppercase transition-all shadow-xl shadow-blue-600/20 flex items-center gap-2"
            >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-bgCard rounded-3xl p-8 border border-borderColor shadow-sm relative overflow-hidden group">
          <div className="flex items-center gap-3 mb-6 border-b border-borderColor pb-4">
            ...
            <div>
              <h3 className="text-lg font-extrabold text-textPrimary">Traditional Approach</h3>
              <p className="text-[11px] font-bold text-textMuted uppercase tracking-widest">Limitations</p>
            </div>
          </div>
        ...
        <div className="bg-bgCard rounded-3xl p-8 border border-emerald-500/30 shadow-lg shadow-emerald-500/5 relative overflow-hidden ring-1 ring-emerald-500/20">
          <div className="absolute top-0 right-0 -mr-4 -mt-4 w-32 h-32 bg-emerald-500/10 rounded-full blur-2xl pointer-events-none"></div>
          <div className="flex items-center gap-3 mb-6 border-b border-borderColor pb-4 relative z-10">
            <div className="p-3 bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 rounded-xl shadow-sm border border-emerald-500/20">
              <BrainCircuit className="w-6 h-6" />
            </div>
            <div>
              <h3 className="text-lg font-extrabold text-textPrimary">Our Engineered Solution</h3>
              <p className="text-[11px] font-bold text-emerald-600 dark:text-emerald-400 uppercase tracking-widest">Innovation</p>
            </div>
          </div>
          <ul className="space-y-4 text-sm font-semibold text-textSecondary relative z-10">
            <li className="flex items-start gap-3">
      ...
      <div className="bg-bgCard rounded-3xl p-6 border border-borderColor shadow-xl relative overflow-hidden text-center">
        <h4 className="text-xs font-black uppercase tracking-widest text-textMuted mb-6">End-to-End Pipeline</h4>
        <div className="flex flex-col md:flex-row items-center justify-center gap-4 md:gap-2 text-sm font-bold">
          <div className="px-4 py-2.5 bg-bgPrimary rounded-xl border border-borderColor text-textPrimary flex items-center gap-2">
            <Database className="w-4 h-4 text-blue-500" /> Data Ingestion
          </div>
          <div className="hidden md:block text-textMuted font-black">──►</div>
          <div className="md:hidden text-textMuted font-black">▼</div>
          <div className="px-4 py-2.5 bg-bgPrimary rounded-xl border border-borderColor text-textPrimary flex items-center gap-2">
            <BrainCircuit className="w-4 h-4 text-emerald-500" /> AI Threat Core
          </div>
          <div className="hidden md:block text-textMuted font-black">──►</div>
          <div className="md:hidden text-textMuted font-black">▼</div>
          <div className="px-4 py-2.5 bg-bgPrimary rounded-xl border border-borderColor text-textPrimary flex items-center gap-2">
            <Network className="w-4 h-4 text-purple-500" /> Meta-Calibrator
          </div>
          <div className="hidden md:block text-textMuted font-black">──►</div>
          <div className="md:hidden text-textMuted font-black">▼</div>
          <div className="px-4 py-2.5 bg-bgPrimary rounded-xl border border-borderColor text-textPrimary flex items-center gap-2">
            <Shield className="w-4 h-4 text-red-500" /> Real-Time GIS & Dispatch
          </div>
        </div>
      </div>
